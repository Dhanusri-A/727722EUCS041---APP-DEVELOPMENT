...
const Home = () => {
    ...
    <>
      ...
      <div className="home">
        <header className="home-header">
          <img 
            src="https://as1.ftcdn.net/v2/jpg/05/79/05/62/1000_F_579056236_RbmkrYxKv4IeqCUkCdGKZdNKaRoMA2tR.jpg" 
            alt="Chess Mastery" 
            className="home-image" 
          />
          <div className="header-content">
            <h1 className="welcome-text">Welcome to Cube Chess Academy</h1>
        ...
        <section className="home-highlight">
          <h2>Why Choose Cube Chess Academy?</h2>
          <div className="home-content">
            <p>At Cube Chess Academy, we are committed to fostering chess talent through a unique blend of time-honored techniques and cutting-edge strategies. Our programs are tailored to cater to every skill level, ensuring each participant reaches their full potential.</p>
            <ul>
  ...
  <div className="success-stories">
    <div className="story">
      ...
      <p>"Joining Cube Chess Academy was a game-changer for me. The personalized coaching and strategic insights helped me win my first regional tournament and set new personal records."</p>
  ...
  <div className="success-stories">
    <div className="story">
      ...
      <p>"Cube Chess Academy has been instrumental in my chess journey. The coaches' expertise and the supportive community have helped me achieve my goals and continuously improve my game."</p>
      <p><strong>Achievements:</strong></p>
      <ul>
        <li>
          <i className="fas fa-chess-king" style={{ color: '#ffcc00' }} />
